# Generated by Django 3.2.9 on 2021-11-11 07:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop_app', '0010_auto_20211111_0432'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_measure', models.CharField(help_text='Единица измерения для конкртеного фильтра. Например "Частота процессора (Ghz)". Единицей измерения будет информация в скобках.', max_length=50, verbose_name='Единица измерения для фильтра')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop_app.category', verbose_name='Категория')),
                ('feature', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop_app.productfeatures', verbose_name='Характеристика')),
            ],
        ),
    ]
