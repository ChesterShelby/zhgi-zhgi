...
class LoginForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password'].label = 'Пороль'
    ...
    def clean(self):
        ...
        if user:
            if not user.check_password(password):
                raise forms.ValidationError("Неверный пороль")
...
class RegistrationForms(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].label = 'Логин'
        self.fields['password'].label = 'Пороль'
        self.fields['confirm_password'].label = 'Подтвердите пороль'
    ...
    def clean_email(self):
        ...
        if User.objects.filter(email=email).exists():
            raise forms.ValidationError(f'данный почтовый адрес уже зарегистрирова в системе')
        return email
